            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        ?>
                            <form action="jenis-buku-update.php" method="post" class="mt-3">
                                <input type="hidden" name="id" value="<?php echo $result['id'] ?>">
                                <div class="mb-3">
                                    <label for="title" class="form-label">Label</label>
                                    <input class="form-control" name="label" type="text" id="label" aria-label="default input example" 
                                    value="<?= $result['label']?>"placeholder="label">
                                </div>
